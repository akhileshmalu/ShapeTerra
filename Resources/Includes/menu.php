...
$menu = array(
	array("Dashboard", "#", "&#xe002;" ,"main", true),
	array("User Access", "../Shapeterra/Pages/updateaccess.php", "&#xe057;" ,"admin", false),
	array("Delete Users", "../Shapeterra/Pages/delete.php", "&#xe053;" ,"admin", false),
	);
?>
...
<div class="row" id="top-bar">
	...
	<h1 class="hidde">Shape<span>terra</span></h1>

	<div id="user-name" class="dropdown">
	  <button id="dLabel" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
	    <span class='icon'>&#xe056;</span>John Smith
