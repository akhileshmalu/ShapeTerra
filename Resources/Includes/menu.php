...
<!-- <svg width="34px" height="44px" viewBox="0 0 34 44" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    <defs>
        <rect x="0" y="0" width="33.2727273" height="43.9825" id="rect-1"></rect>
    </defs>
    <g id="logo22" stroke="none" fill="none">
...
<nav class="col-xs-2" id="menu">
	<ul class="col-xs-12 col-lg-offset- col-md-offset-">
		...
		?>
		<li class="" id="header"><a class="goal" href="#" onclick="return false">
		<span id="goal" class="icon minus hidden">&#xe024;</span>
		<span id="goal" class="icon plus">&#xe035;</span>
		Goal Management 
		</a>
		</li>
		<?php
