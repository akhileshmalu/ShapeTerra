<?php
  ...
  while ($data = $getGoals->fetch()){
    ...
    $pdf->MultiCell(40,6,"Linkage to University Goal",1);
    $pdf->MultiCell(40,6,getUnivLinkedGoal($data["LINK_UNIV_GOAL"]),1);
    $pdf->Ln();
    $pdf->MultiCell(40,6,"Goal",1);
    $pdf->MultiCell(40,6,$data["GOAL_STATEMENT"],1);
    $pdf->Ln();
    $pdf->MultiCell(40,6,"Alignment with Mission, Vision, and Values",1);
    $pdf->MultiCell(40,6,$data["GOAL_ALIGNMENT"],1);
    $pdf->Ln();
