...
try
{
    $connection = new PDO(sprintf('mysql:host=%s;dbname=%s', HOSTNAME, DB), USERNAME, PASSCODE);
...
//$BackToFileUploadHome = false;
//$BackToDataDictHome = false;
//$BackTofootnoteHome = false;
//$BackToGoalOutHome = false;
//$BackToGoal = false;
