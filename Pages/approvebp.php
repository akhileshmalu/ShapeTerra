...
<!--        <form action="" method="POST">-->
            <div class="form-group col-xs-6" id="actionlist">
                ...
                <button id="add-mission" type="button" class="btn-primary col-lg-4 col-xs-4 pull-left" data-toggle="modal"
...
<!--        <form action="" method="POST">-->
            <div class="form-group col-xs-6" id="actionlist">
                ...
                <button  type="button" name="nochangevision"
                        class="btn-primary col-lg-4 col-xs-4 pull-left changeTab">Same as Before</button>
                <button id="add-vision" type="button" class="btn-primary col-lg-4 col-xs-4 pull-left" data-toggle="modal"
...
<!--        <form action="" method="POST">-->
            <div class="form-group col-xs-6" id="actionlist">
                <label for="valuetitle">Please Select If <strong>Value Statement</strong> is still as Previous
                    Year:</label>
                <textarea id="valuetitle" rows="5" cols="25" wrap="hard" class="form-control" name="valuestatement"
                          readonly><?php echo $rowsmission['VALUES_STATEMENT']; ?></textarea>
                <button  type="button" name="nochangevalue"
                        class="btn-primary col-lg-4 col-xs-4 pull-left changeTab">Same as Before
                </button>
                <button id="add-value" type="button" class="btn-primary col-lg-4 col-xs-4 pull-left" data-toggle="modal"
...
<!--        <form action="" method="POST">-->
            <div class="form-group col-xs-6" id="actionlist">
                <label for="goaltitle">Please Select Previous year Goal(s) to continue:</label><br>
