...
<!--        </div>-->
        ...
        <div id="" style="margin-top: 10px;" >
            <table class="datadict" action="taskboard/datadictajax.php" title="Data Dictionary">
                <tr>
                    <th col="DATA_ELMNT_FUNC_NAME" width="230" href="<?php echo "../Pages/dataelement.php?elem_id={{columns.ID_DATA_ELEMENT}}&status={{columns.STATUS}}";?>"  type="text">Data Element</th>
                    <!--                        Provost add Element Def Button Control-->
                    <?php if ($_SESSION['login_right'] == 7): ?>
                        <th col="STATUS" width="100" type="text">Status</th>
                    <?php endif; ?>
                    <th col="RESPONSIBLE_PARTY" width="135" type="text">Responsible Party</th>
