...
<?php if (isset($_POST['submit_approve']) || isset($_POST['savedraft'])) { ?>
    <div class="alert">
            ...
            <form action="initiatives.php?linkid=<?php echo $contentlink_id;?>" method="POST" enctype="multipart/form-data">
                ...
                <div id="explearning" class="form-group">
                    ...
                    <div class="form-group form-indent">
                      <textarea id="undergrad" name="ugexplearning" rows="6" cols="25" wrap="hard" class="form-control"  required><?php echo $Initiatives->mybr2nl($rowsexvalue['EXPERIENTIAL_LEARNING_UGRAD']); ?></textarea>
                      <div class="checkbox">
                    ...
                    <h3>Graduate</h3>
                    <div class="form-group form-indent">
                        <textarea id="graduate" name="gradexplearning" rows="6" cols="25" wrap="hard" class="form-control" ><?php echo $Initiatives->mybr2nl($rowsexvalue['EXPERIENTIAL_LEARNING_GRAD']); ?></textarea>
                        <div class="checkbox">
                            <label for="optionalCheck">
                ...
                <div id="" class="form-group form-indent">
                    ...
                    <textarea  name="afford" rows="6" cols="25" wrap="hard" class="form-control" ><?php echo $Initiatives->mybr2nl($rowsexvalue['AFFORDABILITY']); ?></textarea>
                    <div class="checkbox">
                        <label for="optionalCheck">
                ...
                <div id="reputation" class="form-group form-indent">
                    ...
                    <textarea  name="reputation" rows="6" cols="25" wrap="hard" class="form-control" ><?php echo $Initiatives->mybr2nl($rowsexvalue['REPUTATION_ENHANCE']); ?></textarea>
                    <div class="checkbox">
                        <label for="optionalCheck">
                ...
                <div id="challenge" class="form-group form-indent">
                    ...
                    <textarea  name="challenges" rows="6" cols="25" wrap="hard" class="form-control" ><?php echo $Initiatives->mybr2nl($rowsexvalue['CHALLENGES']); ?></textarea>
                    <div class="checkbox">
                        <label for="optionalCheck">
